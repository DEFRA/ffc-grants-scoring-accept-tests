...
describe('Scoring', () => {
  it('should score a valid full combination of questions and answers', async () => {
    ...
    expect(res.body.score.value).toEqual(67.45)
    expect(res.body.score.band).toEqual('Strong')
    ...
    expect(res.body.answers.find((a) => a.questionId === 'impactType').score.value).toBe(7.5)
